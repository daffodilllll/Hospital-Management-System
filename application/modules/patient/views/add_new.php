                            ...
                            <section class="panel">
                                <div class="panel-body">
                                    ...
                                    <form role="form" action="patient/addNew" method="post" enctype="multipart/form-data">
                                       ...
                                       <div class="col-lg-12">
                                            <div>
                                                <button class="btn btn-primary" style="margin-left: 18px; margin-bottom: 10px;">Patient Details</button>
                                            </div>
                                            <div class="col-lg-6">
                                       ...
                                       <div class="col-lg-12">
                                        ...
                                        <div class="col-lg-12">
                                            <div>
                                                <button class="btn btn-primary" style="margin-left: 18px; margin-bottom: 20px; margin-top: 10px;">Medical Demographics</button>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Claim Number</label>
                                                    <input type="text" class="form-control" name="phone" id="exampleInputEmail1" value='<?php
                                                    if (!empty($setval)) {
                                                        echo set_value('phone');
                                                    }
                                        ...
                                        <div class="col-lg-12">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Medicare Card</label>
                                                    <input type="text" class="form-control" name="phone" id="exampleInputEmail1" value='<?php
                                                    if (!empty($setval)) {
                                                        echo set_value('phone');
                                                    }
                                        ...
                                        <section class="">
                                            <button type="submit" name="submit" class="btn btn-info" style="margin-left: 25px;"><?php echo lang('submit'); ?></button>
                                        </section>
                                    </form>
                                </div>
                            </section>
